    ...
    <div className="home-container">
          ...
          <div className="home-content">
            <div className="home-heading07">
              <h1 className="home-header07">
                Welcome to Specialty Fire Services
              </h1>
        ...
        <div id="features" className="home-features">
          <div className="home-content01">
            ...
            <Features
              ...
              description="Stay Compliant: Proactive maintenance and inspection programs to keep your fire protection systems in top condition and ensure ongoing compliance with regulations."
            ></Features>
          </div>
        </div>
      ...
      <section className="home-practices1">
        <div className="home-heading08">
          <h2 className="home-text14">Our Services</h2>
        </div>
        ...
        <div className="home-content03">
          <div className="home-video">
            ...
            <div className="home-play">
              <img alt="image" src="/Icons/play.svg" className="home-image12" />
            </div>
          </div>
      ...
      <section className="home-features1">
        <div className="home-section6">
          <div className="home-content04">
            ...
            <div className="read-more">
              <span className="home-text16">See our doctors</span>
              <img
                alt="image"
                src="/Icons/arrow-2.svg"
          ...
          <img alt="image" src="/xray-1500w.png" className="home-image14" />
        </div>
        <div className="home-section7">
          <div className="home-content05">
            ...
            <div className="read-more">
              <span className="home-text17">Find test</span>
              <img
                alt="image"
                src="/Icons/arrow-2.svg"
          ...
          <img alt="image" src="/lab-1500w.png" className="home-image16" />
        </div>
      ...
      <div className="home-search">
        <div className="home-heading14">
          <h2 className="home-text22">Search diseases &amp; conditions</h2>
        ...
        <div className="home-content08">
          ...
          <div className="home-type-two">
            <div className="home-heading16">
              <h3 className="home-text51">Symptom checker</h3>
            ...
            <div className="home-symptoms">
              <div className="home-row">
                <div className="symptom">
                  <span className="home-text53">Abdominal pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text54">Chest pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text55">Constipation</span>
                </div>
                <div className="symptom">
                  <span className="home-text56">Cough</span>
                </div>
                <div className="symptom">
                  <span className="home-text57">Breath difficulty</span>
                </div>
              </div>
              <div className="home-row1">
                <div className="symptom">
                  <span className="home-text58">Red eye</span>
                </div>
                <div className="symptom">
                  <span className="home-text59">Foot pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text60">Foot swelling</span>
                </div>
                <div className="symptom">
                  <span className="home-text61">Headache</span>
                </div>
                <div className="symptom">
                  <span className="home-text62">Heart palpitation</span>
                </div>
              </div>
              <div className="home-row2">
                <div className="symptom">
                  <span className="home-text63">Knee pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text64">Hip pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text65">Low back pain</span>
                </div>
                <div className="symptom">
                  <span className="home-text66">Nasal congestion</span>
                </div>
                <div className="symptom">
                  <span className="home-text67">Neck pain</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="book" className="home-book5">
        <div className="home-heading17">
          <h2 className="home-text68">Book an appointment</h2>
        ...
        <div className="home-form">
          <div className="home-types1">
            <div className="book-type">
              <span className="home-text70">In person appointment</span>
            </div>
            <div className="book-type">
              <span className="home-text71">Virtual appointment</span>
            </div>
          </div>
            ...
            <div className="home-lower">
              ...
              <div className="home-button">
                ...
                <p className="home-text74">
                  ...
                  <span className="home-text76">adipiscing elit</span>
                  <span>
                  ...
                  <span className="home-text78">incididunt</span>
                  <span>.</span>
                </p>
              </div>
            </div>
      ...
      <section className="home-meet">
        <div className="home-heading18">
          <h2 className="home-text80">Meet our doctors</h2>
      ...
      <section className="home-news">
        <div className="home-heading19">
          <h2 className="home-text83">Read our latest news</h2>
        ...
        <div className="home-list2">
          <div className="home-item">
            ...
            <div className="home-content09">
              ...
              <div className="read-more">
                <span className="home-text85">Read more</span>
                <img
                  alt="image"
                  src="/Icons/arrow.svg"
      ...
      <div className="home-download">
        <div className="home-main1">
          <img alt="image" src="/phone-1500w.png" className="home-image28" />
          <div className="home-content12">
            <h2 className="home-text88">
